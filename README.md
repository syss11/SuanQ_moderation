...
可以配置AI人设回复与审核功能，提供多样指令
包含“群聊协管“功能，可任命协管成员共治群聊，权限限制完备
可长时间运行，自动重连，Docker一键部署，自动清理图片资源
...
12. 协管功能-可任命协管成员，通过指令参与群聊管理，裁决点机制约束
...
5. AI率：中。多数架构与细节受过人类优化，且经过测试与长时间实际使用。
6. 本项目仅供学习与日常实用，不建议专业使用或用于不恰当用途。
7. 如有任何问题或建议，可联系作者或加入群聊1047717393